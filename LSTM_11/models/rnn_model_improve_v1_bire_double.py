...
class Encoder_Decoder(nn.Module):
    def __init__(self, hidden_size, output_size=1, n_layers=1, use_cuda=True):
        ...
        # shared weights
        self.appear_linear = nn.Linear(1024, 2*hidden_size)
        self.score_linear_1 = nn.Linear(80*32, 512)
        self.score_linear_2 = nn.Linear(512, 2*hidden_size)
        self.box_linear = nn.Linear(80*4, 2*hidden_size)

        self.all_feature_linear = nn.Linear(6*hidden_size, hidden_size)

...
from models.rnn_model_full_global_attention_context_gate_no_appear import Encoder_Decoder
from dataset.multi_dataset_after_from_before_nms_threshold_v2 import TrainDataset, unique_collate
...
if __name__ == '__main__':
    ...
    # dataset
    train = TrainDataset(args.base_path, args.img_list, args.use_mode, cls_list, weight=args.weight, final_score_thresh=args.final_score_thresh, overlap_thresh=args.overlap_thresh)

...
from dataset.multi_dataset_after_nms import TrainDataset, unique_collate
from solver import solver, load_checkpoint
import torch
import argparse
import os
...
if __name__ == '__main__':
    ...
    # dataset
    train = TrainDataset(args.base_path, args.img_list, args.use_mode, cls_list)

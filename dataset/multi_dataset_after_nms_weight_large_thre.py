...
class TrainDataset(MultiDataset):
    def __init__(self, base_path, txt_name, use_mode, cls_list, overlap_thresh=0.5, score_thresh=0.03, weight=1.2, phase='train'):
    ...
    def __getitem__(self, idx):
        ...
        proposals_feature_nms, proposals_score_nms, proposals_box_nms, proposals_label, proposals_weight, proposals_keep_np = stage2_assign_weight_slack(box_feature, box_box, box_score, gts_box, weight=self.weight, score_thresh=self.score_thresh)

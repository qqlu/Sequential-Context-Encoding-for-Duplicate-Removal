...
class Encoder_Decoder(nn.Module):
    def __init__(self, hidden_size, output_size=1, n_layers=1, use_cuda=True, attn_type='dot', context_type=None):
        ...
        self.feature_linear = nn.Linear(hidden_size+64, hidden_size)
    ...
    def forward(self, all_class_box_feature_variable, all_class_box_box_variable, all_class_box_score_variable, all_class_box_origin_score_variable, unique_class, unique_class_len):
        ...
        # encoder_all_feature = torch.cat((encoder_box_feature, all_class_box_score_variable, all_class_box_box_variable), 1)
        encoder_all_feature = torch.cat((encoder_box_feature, all_class_box_score_variable, all_class_box_origin_score_variable), 1)
        # encoder_all_feature = torch.cat((encoder_box_feature, all_class_box_box_variable, all_class_box_origin_score_variable), 1)

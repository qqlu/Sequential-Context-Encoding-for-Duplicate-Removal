...
class TrainDataset(MultiDataset):
    ...
    def __getitem__(self, idx):
        ...
        for ii in range(80):
            ...
            all_class_box_label[start:start+filter_num, 0:1], all_class_box_weight[start:start+filter_num, 0:1] = stage_full_assign_weight_slack_has_class_v6(all_class_box_origin_box[start:start+filter_num, :], all_class_box_origin_score[start:start+filter_num, 0:1], gts_box, ii, weight=self.weight, pos_iou_thr=self.overlap_thresh)
        # final box

...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self, all_class_box_feature_variable, all_class_box_box_variable, all_class_box_score_variable, all_class_box_origin_score_variable, unique_class, unique_class_len):
        ...
        # encoder
        decoder_box_feature = F.relu(self.appear_linear(all_class_box_feature_variable))
        decoder_all_feature = torch.cat((decoder_box_feature, all_class_box_score_variable, all_class_box_box_variable, all_class_box_origin_score_variable), 1)

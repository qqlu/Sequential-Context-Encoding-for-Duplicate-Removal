...
from models.rnn_model_full_mulheadcontext_mainappear import Encoder_Decoder
from dataset.multi_dataset_after_nms_weight_v2 import TrainDataset, unique_collate
from solver.solver_full_nms_weight_mul import solver, load_checkpoint
import torch
import argparse
import os
...
if __name__ == '__main__':
    ...
    # model
    model = Encoder_Decoder(args.hidden_size, n_layers=args.num_layers, attn_type=args.attn_type, context_type=args.context_type)
    if args.load:

...
# from dataset.multi_dataset_after_from_before_nms_threshold_ import TrainDataset, unique_collate
from dataset.multi_dataset_after_from_before_nms_threshold_v3 import TrainDataset, unique_collate
...
def run(thread_index, thread_num, result, args):
    ...
    # datasets
    val = TrainDataset(args.base_path, args.img_list, args.use_mode, cls_list, final_score_thresh=0.01, phase='test')
...
if __name__ == '__main__':
    with Manager() as manager:
        ...
        result_path = '/mnt/lustre/liushu1/qilu_ex/check_after_from_before.json'
        result = manager.list()

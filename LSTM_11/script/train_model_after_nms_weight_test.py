...
from models.rnn_model_improve_v1_bire_test import Encoder_Decoder
from dataset.multi_dataset_after_nms_weight_large_thre import TrainDataset, unique_collate
from solver.solver_after_nms_weight_test import solver, load_checkpoint
import torch
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument('--output_dir',
    					default='/mnt/lustre/liushu1/qilu_ex/RNN_NMS/test/',
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(train, batch_size=1, num_workers=1, collate_fn=unique_collate, pin_memory=False, shuffle=False)

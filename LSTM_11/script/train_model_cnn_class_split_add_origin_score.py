...
from models.cnn_model_class_split_add_origin_score_modify_rank import Encoder_Decoder
from dataset.multi_dataset_after_nms_weight_class_split_add_origin_score import TrainDataset, unique_collate
from solver.solver_after_nms_weight_class_split_add_origin_score import solver, load_checkpoint
import torch
import argparse
import os

def parse_args():
    parser = argparse.ArgumentParser(description='Train CNN NMS')

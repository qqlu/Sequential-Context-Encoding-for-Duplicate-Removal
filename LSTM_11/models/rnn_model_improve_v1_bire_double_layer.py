...
class Encoder_Decoder(nn.Module):
    def __init__(self, hidden_size, output_size=1, n_layers=1, use_cuda=True):
        ...
        self.encoder_rnn_2 = nn.GRU(2*hidden_size, hidden_size, bidirectional=True)
    ...
    def forward(self, boxes_feature, boxes_box_score, boxes_box, num_proposals):
        ...
        for j in range(self.n_layers):
            ...
            encoder_output_1, hidden_encoder_1 = self.encoder_rnn_1(encoder_input, hidden_encoder)
            # print(encoder_output_1.size())
            # print(encoder_input.size())
            encoder_output_2, hidden_encoder_2 = self.encoder_rnn_2(encoder_output_1, hidden_encoder)
            hidden_decoder_1 = hidden_encoder_1
            hidden_decoder_2 = hidden_encoder_2
            decoder_output_1, hidden_decoder = self.encoder_rnn_1(encoder_input, hidden_decoder_1)
            decoder_output, hidden_decoder = self.encoder_rnn_2(decoder_output_1, hidden_decoder_2)

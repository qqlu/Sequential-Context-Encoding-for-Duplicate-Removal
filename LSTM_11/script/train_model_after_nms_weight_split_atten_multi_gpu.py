...
from models.rnn_model_improve_v1_split_atten_multi_gpu import Encoder_Decoder
from dataset.multi_dataset_after_nms_weight_multi_gpu import TrainDataset, unique_collate
from solver.solver_after_nms_weight_atten_multi_gpu import solver, load_checkpoint
import torch
import argparse
import os
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(train, batch_size=4, num_workers=4, collate_fn=unique_collate, pin_memory=False, shuffle=True)

...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self, boxes_feature, boxes_box_score, boxes_box, num_proposals):
        ...
        for j in range(self.n_layers):
            ...
            hidden_decoder_final = hidden_decoder
            decoder_output_final, hidden_decoder_final = self.encoder_rnn(encoder_input, hidden_decoder_final)
            hidden_decoder_final_final = hidden_decoder_final
            decoder_output_final_final, hidden_decoder_final_final = self.encoder_rnn(encoder_input, hidden_decoder_final_final)
        
        output = self.sigmoid(self.out(decoder_output_final_final))
        # print(output)
        return output

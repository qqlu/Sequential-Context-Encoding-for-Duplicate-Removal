...
from utils import stage2_assign
...
class TrainDataset(MultiDataset):
    ...
    def __getitem__(self, idx):
        ...
        # true_num = len(np.where(proposals_label==1)[0])
        # false_num = proposals_label.shape[0]-true_num
        # logger1.info('{}/{}'.format(true_num, false_num))
        # input()

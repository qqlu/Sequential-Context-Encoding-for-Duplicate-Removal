...
def test(all_class_box_feature_variable, all_class_box_box_variable, all_class_box_score_variable, all_class_box_origin_score_variable, all_class_box_origin_box_variable, unique_class_cuda, unique_class_len_cuda, model):

    output_record = model(all_class_box_feature_variable, all_class_box_box_variable, all_class_box_score_variable, all_class_box_origin_score_variable, all_class_box_origin_box_variable, unique_class_cuda, unique_class_len_cuda)
...
def test_solver(model, dataset, output_dir, thread_index, thread_num):
    ...
    for count in range(data_num):
        ...
        output = test(all_class_box_feature_variable, all_class_box_box_variable, all_class_box_score_variable, all_class_box_origin_score_variable, all_class_box_origin_box_variable, unique_class_cuda, unique_class_len_cuda, model)

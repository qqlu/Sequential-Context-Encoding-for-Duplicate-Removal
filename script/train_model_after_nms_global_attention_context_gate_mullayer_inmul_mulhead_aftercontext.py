...
from models.rnn_model_full_global_attention_context_gate_mullayer_inmul_mulhead_aftercontext import Encoder_Decoder
...
if __name__ == '__main__':
    ...
    # model
    model = Encoder_Decoder(args.hidden_size, n_layers=args.num_layers, attn_type=args.attn_type, context_type=args.context_type, multi_head=args.multi_head)
    if args.load:

...
class TrainDataset(MultiDataset):
    ...
    def __getitem__(self, idx):
        ...
        proposals_feature_nms, proposals_score_nms, proposals_box_nms, proposals_label, proposals_weight, proposals_class, proposals_keep_np = stage2_assign_weight_slack_has_class(box_feature, box_box, box_score, gts_box, weight=self.weight, pos_iou_thr=0.1)

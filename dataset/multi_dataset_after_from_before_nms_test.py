...
from utils.bbox_ops import stage_full_assign_weight_slack_has_class_v4
...
class TrainDataset(MultiDataset):
    ...
    def __getitem__(self, idx):
        ...
        box_label, box_weight = stage_full_assign_weight_slack_has_class_v4(box_feature, box_box, box_score, gts_box, weight=self.weight)
